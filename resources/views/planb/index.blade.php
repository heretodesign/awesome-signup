    ...
    <div class="container has-background-primary">
        <div class="columns is-mobile">
          <div class="column is-three-fifths is-offset-one-fifth">
            ...
            <br>
            <p class="control">
                <a   href="{{ route('twenty.create') }}" class="button is-link">
                  Add New Signup
                </a>
              </p>
          </div>
                                ...
                                <tr class="bg-grey-darkest">
                                    ...
                                    <td>
                                      <div class="field is-grouped">
                                          <p class="control">
                                            <a href="{{ route('twenty.show', $signup->id) }}" class="button is-primary">Show</a>
                                          </p>
                                          <p class="control">
                                            <a href="{{ route('twenty.edit', $signup->id) }}" class="button is-primary">Edit</a>
                                          </p>
                                          <form action="{{ route('twenty.destroy', $signup->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <p class="control">
