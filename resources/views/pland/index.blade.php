    ...
    <div class="container has-background-primary">
        <div class="columns is-mobile">
          <div class="column is-three-fifths is-offset-one-fifth">
            <h2 class="is-size-4">Signup for 50% Discount</h2>
            <br>
            <a  href="{{ route('admin.dashboard') }}" class="button is-info">Return to Admin Dashboard</a>
            <br>
            <br>
            <p class="control">
                <a   href="{{ route('fifty.create') }}" class="button is-link">
                  Add New Signup
                </a>
              </p>
          </div>
                                ...
                                <tr class="bg-grey-darkest">
                                    ...
                                    <td>
                                      <div class="field is-grouped">
                                          <p class="control">
                                            <a href="{{ route('fifty.show', $signup->id) }}" class="button is-primary">Show</a>
                                          </p>
                                          <p class="control">
                                            <a href="{{ route('fifty.edit', $signup->id) }}" class="button is-primary">Edit</a>
                                          </p>
                                          <form action="{{ route('fifty.destroy', $signup->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <p class="control">
