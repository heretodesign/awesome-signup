                    ...
                    <form action="">
                      <div class="field">
                        <div class="control is-medium ">
                          <input class="input is-medium" name="email" type="text" placeholder="Email Address">
                        </div>
                      </div>
                      <div class="field">
                        <div class="control is-medium ">
                          <input class="input is-medium" type="text" name="address" placeholder="Address">
                        </div>
                      </div>
                          ...
                          <div class="field-body">
                            <div class="field">
                              <p class="control is-expanded has-icons-left">
                                <input class="input is-medium" type="text" name="city" placeholder="City">
                              </p>
                            </div>
                            <div class="field">
                              <p class="control is-expanded has-icons-left has-icons-right">
                                <input class="input is-medium" type="text" name="state" placeholder="State">
                              </p>
                            </div>
                          </div>
                      </div>
                      <div class="field is-horizontal">
                          <div class="field-body">
                            <div class="field">
                              <p class="control is-expanded has-icons-left">
                                <input class="input is-medium" name="country" type="text" placeholder="Country">
                              </p>
                            </div>
                            <div class="field">
                              <p class="control is-expanded has-icons-left has-icons-right">
                                <input class="input is-medium" name="phone" type="email" placeholder="Phone">
                              </p>
                            </div>
                          </div>
                      </div>
                      <div class="field">
                        <div class="control is-medium ">
                          <input class="input is-medium" type="text" name="name_on_card" placeholder="Name on Card">
                        </div>
                      </div>
                      <div class="field">
                        <div class="control is-medium">
                          <input class="input is-medium" type="text" name="card_number" placeholder="Card Number">
                        </div>
                      </div>
                      <div class="field">
                        <div class="control is-medium">
                          <input class="input is-medium" type="text" name="validity" placeholder="Valid Through: MM / YY">
                        </div>
                      </div>
                      <div class="field">
                        <div class="control is-medium">
                          <input class="input is-medium" type="text" name="cvc" placeholder="CVC">
                        </div>
                      </div>
                      <div class="field">
                        <div class="control is-medium">
