    ...
    <div class="container has-background-primary">
        <div class="columns is-mobile">
          <div class="column is-three-fifths is-offset-one-fifth">
            <h2 class="is-size-4">Signup for 30% Discount</h2>
            <br>
            <a  href="{{ route('admin.dashboard') }}" class="button is-info">Return to Admin Dashboard</a>
            <br>
            <br>
            <p class="control">
                <a   href="{{ route('thirty.create') }}" class="button is-link">
                  Add New Signup
                </a>
              </p>
          </div>
                                ...
                                <tr class="bg-grey-darkest">
                                    ...
                                    <td>
                                      <div class="field is-grouped">
                                          <p class="control">
                                            <a href="{{ route('thirty.show', $signup->id) }}" class="button is-primary">Show</a>
                                          </p>
                                          <p class="control">
                                            <a href="{{ route('thirty.edit', $signup->id) }}" class="button is-primary">Edit</a>
                                          </p>
                                          <form action="{{ route('thirty.destroy', $signup->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <p class="control">
